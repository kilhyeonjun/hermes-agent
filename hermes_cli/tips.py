...
TIPS = [
    ...
    "hermes profile create work --clone copies config, .env keys, SOUL, curated memory files, and skills to a new profile.",
    ...
    "hermes profile create backup --clone-all copies .env secrets and working state, but excludes history and auth.json/auth.lock/.op.env; re-authenticate OAuth providers in the clone.",
