...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("session-model", "Detailed model and reasoning settings for this Telegram session only", "Configuration",
               aliases=("session_model",), gateway_only=True),
    CommandDef("session-fast", "Set Priority Processing for this Telegram session only", "Configuration",
               aliases=("session_fast",), gateway_only=True),
    ...
    CommandDef("codex-route", "Set Codex routing to auto, personal, or company across profiles", "Configuration",
               aliases=("codex_route",), args_hint="[status|auto|personal|company]", gateway_only=True),
    CommandDef("codex-account", "Control native Codex account routing on the Mac mini", "Configuration",
               aliases=("codex_account",),
               args_hint="[status|auto|personal|company]", gateway_only=True),
...
#   - codex_account: Mac-mini account routing control; /codex_route stays native.
#   - insights, platform, update, version: lower-frequency administrative/info
#     surfaces kept reachable through /hermes so the 50-slot cap is explicit.
_SLACK_VIA_HERMES_ONLY = frozenset({
    "credits", "billing", "moa", "debug", "codex_account",
    "insights", "platform", "update", "version",
})
