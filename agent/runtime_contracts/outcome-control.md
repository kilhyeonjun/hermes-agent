<rule_contract id="OUTCOME_CONTROL_V1">
  ...
  <required_action name="blocks_current_user_outcome">REVIEW_SCOPE_ATTRIBUTION: Block/auto-fix only evidenced task-owned requirements or diff regressions blocking outcome/verification.</required_action>
